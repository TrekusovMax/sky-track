...
export function FlightDetails() {
	...
	return (
		<aside className='xs:rounded-lg xs:top-35 xs:inset-2.5 xs:w-[95%] absolute top-7 right-7 w-md overflow-hidden rounded-xl bg-[#101010] sm:inset-3 sm:top-21 sm:w-[96%] md:top-28'>
